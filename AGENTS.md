...
**Available tools:** `wave_help`, `wave_server_info`, `wave_gpu_doctor`, `wave_audit`, `wave_map`, `wave_scan_secrets`, `wave_install_audit`, `wave_run_sensors`, `docs_search`, `code_search`, `code_ask`, `seed_get`, `wave_current`, `wave_list_waves`, `wave_list_plans`, `wave_get_change`, `wave_get_prompt`, `wave_get_handoff`, `wave_set_handoff`, `wave_gate_open`, `wave_gate_close`, `wave_gate_status`, `wave_create_wave`, `wave_add_change`, `wave_remove_change`, `wave_prepare`, `wave_pause`, `wave_review`, `wave_record_review_evidence`, `wave_context_efficiency_attach_evaluation`, `wave_close`, `wave_memory_add`, `wave_memory_propose`, `wave_memory_backfill`, `wave_memory_validate`, `wave_memory_search`, `wave_memory_brief`, `wave_memory_reconcile`, `wave_new_feature`, `wave_new_bug`, `wave_new_enhancement`, `wave_new_refactor`, `wave_new_change`, `wave_new_documentation`, `wave_new_tech_debt`, `wave_new_task`, `wave_new_maintenance`, `wave_new_operations`, `wave_validate`, `wave_garden`, `wave_sync_surfaces`, `wave_index_health`, `wave_index_build_status`, `wave_index_build`, `wave_index_optimize`, `wave_mcp_reload`, `wave_implement`, `wave_reopen`, `wave_upgrade`, `wave_upgrade_status`, `wave_dashboard_start`, `wave_dashboard_stop`, `wave_dashboard_restart`, `wave_dashboard_open`, `code_list_files`, `code_read`, `code_keyword`, `code_lexical`, `code_constants`, `code_pattern`, `code_outline`, `code_definition`, `code_references`, `code_dependencies`, `code_impact`, `code_callgraph`, `code_callhierarchy`, `code_graph_path`, `code_graph_community`, `code_commit_provenance`, `code_hover`, `code_risk_score`, `wave_graph_report`.
