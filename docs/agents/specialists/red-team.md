...
The standalone modes below are operator-invocable directly via the **Red-team review** command (`docs/prompts/red-team-review.prompt.md`), which records no signoffs and satisfies no gate.
