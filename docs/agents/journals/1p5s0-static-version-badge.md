...
- **Role:** wave-coordinator for wave `1p5s0 static-version-badge`. **Responsibility:** coordinate the wave's admitted changes through prepare → implement → review → close per the lifecycle contract.
...
- Pending: wave `1p5s0 static-version-badge` opened 2026-06-15; populate as admitted changes move through implementation.
