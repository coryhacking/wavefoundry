# Journal - Lance Drift Eligibility
...
- **Role:** wave-coordinator for wave `1roqn lance-drift-eligibility`. **Responsibility:** coordinate the wave's admitted changes through prepare → implement → review → close per the lifecycle contract.
...
- Pending: wave `1roqn lance-drift-eligibility` opened 2026-07-03; populate as admitted changes move through implementation.
