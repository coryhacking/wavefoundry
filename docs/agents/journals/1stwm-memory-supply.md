...
- **Role:** wave-coordinator for wave `1stwm memory-supply`. **Responsibility:** coordinate the wave's admitted changes through prepare → implement → review → close per the lifecycle contract.
...
- Pending: wave `1stwm memory-supply` opened 2026-07-17; populate as admitted changes move through implementation.
