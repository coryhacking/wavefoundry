...
- **Role:** wave-coordinator for wave `1p6lp cross-host-skills`. **Responsibility:** coordinate the wave's admitted changes through prepare → implement → review → close per the lifecycle contract.
...
- Pending: wave `1p6lp cross-host-skills` opened 2026-06-19; populate as admitted changes move through implementation.
