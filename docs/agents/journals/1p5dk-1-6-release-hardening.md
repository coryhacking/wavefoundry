...
- **Role:** wave-coordinator for wave `1p5dk 1-6-release-hardening`. **Responsibility:** coordinate the wave's admitted changes through prepare → implement → review → close per the lifecycle contract.
...
- Pending: wave `1p5dk 1-6-release-hardening` opened 2026-06-13; populate as admitted changes move through implementation.
