# Journal - Downstream Upgrade Fixes
...
- **Role:** wave-coordinator for wave `1p8xm downstream-upgrade-fixes`. **Responsibility:** coordinate the wave's admitted changes through prepare → implement → review → close per the lifecycle contract.
...
- Pending: wave `1p8xm downstream-upgrade-fixes` opened 2026-06-29; populate as admitted changes move through implementation.
