# Journal - External Supertype Visibility
...
- **Role:** wave-coordinator for wave `1sbfi external-supertype-visibility`. **Responsibility:** coordinate the wave's admitted changes through prepare → implement → review → close per the lifecycle contract.
...
- Pending: wave `1sbfi external-supertype-visibility` opened 2026-07-11; populate as admitted changes move through implementation.
