...
- **Role:** wave-coordinator for wave `1p5x8 large-codebase-map`. **Responsibility:** coordinate the wave's admitted changes through prepare → implement → review → close per the lifecycle contract.
...
- Pending: wave `1p5x8 large-codebase-map` opened 2026-06-16; populate as admitted changes move through implementation.
