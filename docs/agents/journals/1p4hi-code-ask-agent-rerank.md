...
- **Role:** wave-coordinator for wave `1p4hi code-ask-agent-rerank`. **Responsibility:** coordinate the wave's admitted changes through prepare → implement → review → close per the lifecycle contract.
...
- Pending: wave `1p4hi code-ask-agent-rerank` opened 2026-06-09; populate as admitted changes move through implementation.
