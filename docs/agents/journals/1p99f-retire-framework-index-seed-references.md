# Journal - Retire Framework Index Seed References
...
- **Role:** wave-coordinator for wave `1p99f retire-framework-index-seed-references`. **Responsibility:** coordinate the wave's admitted changes through prepare → implement → review → close per the lifecycle contract.
...
- Pending: wave `1p99f retire-framework-index-seed-references` opened 2026-07-01; populate as admitted changes move through implementation.
