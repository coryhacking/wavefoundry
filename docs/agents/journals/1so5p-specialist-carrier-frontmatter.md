# Journal - Specialist Carrier Frontmatter
...
Schema version: 1.0
Last distilled: 2026-07-15

wave-id: `1so5p specialist-carrier-frontmatter`

## Operating Identity

- **Role:** wave-coordinator for wave `1so5p specialist-carrier-frontmatter`. **Responsibility:** coordinate the wave's admitted changes through prepare → implement → review → close per the lifecycle contract.
...
- Pending: wave `1so5p specialist-carrier-frontmatter` opened 2026-07-15; populate as admitted changes move through implementation.
