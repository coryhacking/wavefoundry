# Journal - Gpu Doctor Mcp Stdout Fd Hang
...
- **Role:** wave-coordinator for wave `1p8vd gpu-doctor-mcp-stdout-fd-hang`. **Responsibility:** coordinate the wave's admitted changes through prepare → implement → review → close per the lifecycle contract.
...
- Pending: wave `1p8vd gpu-doctor-mcp-stdout-fd-hang` opened 2026-06-29; populate as admitted changes move through implementation.
