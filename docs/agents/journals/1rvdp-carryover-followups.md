...
- **Role:** wave-coordinator for wave `1rvdp carryover-followups`. **Responsibility:** coordinate the wave's admitted changes through prepare → implement → review → close per the lifecycle contract.
...
- Pending: wave `1rvdp carryover-followups` opened 2026-07-06; populate as admitted changes move through implementation.
