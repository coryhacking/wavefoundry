# Journal - Commit Reasoning Provenance
...
- **Role:** wave-coordinator for wave `1sufq commit-reasoning-provenance`. **Responsibility:** coordinate the wave's admitted changes through prepare → implement → review → close per the lifecycle contract.
...
- Pending: wave `1sufq commit-reasoning-provenance` opened 2026-07-17; populate as admitted changes move through implementation.
