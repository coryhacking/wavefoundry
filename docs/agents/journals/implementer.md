...
- Responsibilities include: following the change doc Requirements/Scope/AC, detecting code patterns before implementing, running framework tests and docs-lint after changes, handing off diff and suggested commit message without committing.
