...
- **Role:** wave-coordinator for wave `1t550 upgrade-field-fixes`. **Responsibility:** coordinate the wave's admitted changes through prepare → implement → review → close per the lifecycle contract.
...
- Pending: wave `1t550 upgrade-field-fixes` opened 2026-07-21; populate as admitted changes move through implementation.
