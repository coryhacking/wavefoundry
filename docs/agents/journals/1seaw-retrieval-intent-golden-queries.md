# Journal - Retrieval Intent Golden Queries
...
- **Role:** wave-coordinator for wave `1seaw retrieval-intent-golden-queries`. **Responsibility:** coordinate the wave's admitted changes through prepare → implement → review → close per the lifecycle contract.
...
- Pending: wave `1seaw retrieval-intent-golden-queries` opened 2026-07-12; populate as admitted changes move through implementation.
