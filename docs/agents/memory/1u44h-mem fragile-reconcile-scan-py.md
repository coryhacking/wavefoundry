...
Memory ID: `1u44h-mem fragile-reconcile-scan-py`
Kind: `fragile_file`
Confidence: 0.6
Created: 2026-07-31
Updated: 2026-07-31
...
reconcile_scan.py required 4 separate repairs during wave 1u2b0; treat it as fragile and re-verify edits with the full suite before relying on them.
