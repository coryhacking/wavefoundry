...
Memory ID: `1yyc1-mem repaired-defect-docs-del-1`
Kind: `failed_attempt`
Confidence: 0.6
Created: 2026-09-25
Updated: 2026-09-25
...
Superseded by: `1yx4v-mem a-comment-only-edit-to-retrieval-eval-py-invalidates-every-r`

## Summary

Real defect fixed in wave 1yxyw: Resolved: repair verified by the original lane in an independent context.
