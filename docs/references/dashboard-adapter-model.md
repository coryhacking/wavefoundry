...
| Index health | `.wavefoundry/index/index.sqlite` (build snapshot; wave 1sed7) | `collect_dashboard_snapshot` |
...
| No completed build epoch in `index.sqlite` | Index tile shows `unknown` |
