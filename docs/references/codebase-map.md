...
_Grouping: graph communities collapsed to packages/directories. Areas shown: 24 of 120. Cluster builder version: `13`. Files in scope: 528; symbols: 63166._
...
- Size: 1326 graph nodes
- Key entry points (by cross-file fan-in): `load_record_roots` (function), `_load_script` (function), `RuntimeFileLock` (class), `_response` (function), `_diagnostic` (function)
...
- Key files: `.wavefoundry/framework/scripts/wave_lint_lib/wave_validators.py`, `.wavefoundry/framework/scripts/memory_records.py`, `.wavefoundry/framework/scripts/wave_lint_lib/cli.py`, `.wavefoundry/framework/scripts/wave_lint_lib/helpers.py`, `.wavefoundry/framework/scripts/commit_provenance.py`, `.wavefoundry/framework/scripts/wave_lint_lib/core_validators.py`
...
- Key entry points (by cross-file fan-in): `acquire` (function), `runtime_database_path` (function), `invalidate` (function), `GraphQueryIndex` (class), `read_graph_payload` (function)
...
- Key entry points (by cross-file fan-in): `index_database_path` (function), `wave_id_of` (function), `build_prefix` (function), `legacy_index_database_path` (function), `load_lifecycle_policy` (function)
- Key files: `.wavefoundry/framework/scripts/dashboard_lib.py`, `.wavefoundry/framework/scripts/dashboard_server.py`, `.wavefoundry/framework/scripts/lifecycle_id.py`, `.wavefoundry/framework/scripts/index_paths.py`, `.wavefoundry/framework/scripts/wave_lint_lib/core_validators.py`, `.wavefoundry/framework/scripts/record_paths.py`
...
96 additional smaller area(s) are not shown here to keep the top tier readable. Enumerate the full community structure with `code_graph_report(sections=["communities"], limit=100)` and drill in with `code_graph_community`.
