...
_Grouping: graph communities collapsed to packages/directories. Areas shown: 24 of 123. Cluster builder version: `13`. Files in scope: 583; symbols: 63912._
...
- Key entry points (by cross-file fan-in): `windowless_pythonw` (function), `utf8_child_env` (function), `tool_venv_python` (function), `index_publication_scope` (function), `_probe_index_build_lock` (function)
...
- Key entry points (by cross-file fan-in): `acquire` (function), `runtime_database_path` (function), `index_database_path` (function), `invalidate` (function), `isolated_stdout_fd` (function)
- Key files: `.wavefoundry/framework/scripts/dashboard_lib.py`, `.wavefoundry/framework/scripts/dashboard_server.py`, `.wavefoundry/framework/scripts/graph_query.py`, `.wavefoundry/framework/scripts/graph_snapshot.py`, `.wavefoundry/framework/scripts/index_paths.py`, `.wavefoundry/framework/scripts/cli_stdio.py`
...
- Key entry points (by cross-file fan-in): `contained_resolved_path` (function), `sync_inventory` (function), `ensure_run` (function), `discover_root` (function), `load_memory_records` (function)
- Key files: `.wavefoundry/framework/scripts/memory_records.py`, `.wavefoundry/framework/scripts/memory_backfill.py`, `.wavefoundry/framework/scripts/memory_supply.py`, `.wavefoundry/framework/scripts/path_containment.py`, `.wavefoundry/framework/scripts/repo_root.py`, `.wavefoundry/framework/scripts/wf_server/server_impl.py`
