...
_Grouping: graph communities collapsed to packages/directories. Areas shown: 24 of 124. Cluster builder version: `13`. Files in scope: 584; symbols: 63948._
...
- Size: 583 graph nodes
- Key entry points (by cross-file fan-in): `isolated_run` (function), `connect` (function), `RuntimeFileLock` (class), `update_upgrade_lock` (function), `write_upgrade_lock` (function)
