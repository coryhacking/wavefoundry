...
_Grouping: graph communities collapsed to packages/directories. Areas shown: 24 of 45. Cluster builder version: `11`. Files in scope: 197; symbols: 14137._
...
- Size: 860 graph nodes
- Key entry points (by cross-file fan-in): `project_state_publication_lock` (function), `_load_script` (function), `ProcessTelemetry` (class), `load_memory_records` (function), `memory_validate_response` (function)
...
- Key entry points (by cross-file fan-in): `RuntimeFileLock` (class), `acquire` (function), `release` (function), `write_metadata` (function), `probe_runtime_lock` (function)
- Key files: `.wavefoundry/framework/scripts/indexer.py`, `.wavefoundry/framework/scripts/runtime_lock.py`, `.wavefoundry/framework/scripts/dashboard_lib.py`, `.wavefoundry/framework/scripts/server_impl.py`
...
- Size: 83 graph nodes
- Key entry points (by cross-file fan-in): `render_review_status_projection` (function), `render_review_evidence_projection` (function), `empty_external_finding_synthesis_section` (function), `validate_external_review_evidence` (function), `parse_review_evidence_source` (function)
- Key files: `.wavefoundry/framework/scripts/review_evidence.py`, `.wavefoundry/framework/scripts/server_impl.py`, `.wavefoundry/framework/scripts/dashboard_lib.py`
...
- Size: 67 graph nodes
- Key entry points (by cross-file fan-in): `build_prefix` (function), `should_exclude` (function), `load_lifecycle_policy` (function), `encode_base36` (function), `build_zip` (function)
