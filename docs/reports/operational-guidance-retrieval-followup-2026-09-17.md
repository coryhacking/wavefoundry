...
[Evidence and judgments](operational-guidance-retrieval-followup-2026-09-17.json) retain the declared facts, selected passages, candidate identities/scores, scope predicate, exclusion census and scratch driver. Unselected passage bodies and the full database are not retained, so this is auditable evidence rather than a turnkey frozen benchmark.
