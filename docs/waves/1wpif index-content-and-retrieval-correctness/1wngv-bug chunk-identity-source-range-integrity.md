...
- [x] AC-7: The chunker/index version and chunking/search architecture documentation identify the compatibility boundary and rebuild requirement; focused and full framework tests pass.
