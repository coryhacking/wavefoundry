...
| ---- | ---- | ---- | ------------ |
| tests | `.wavefoundry/framework/scripts/tests` | code | 11163 |
| server_impl | `.wavefoundry/framework/scripts` | code | 757 |
| graph | `.wavefoundry/framework/scripts` | code | 356 |
| dashboard_lib | `.wavefoundry/framework/scripts` | code | 223 |
| dashboard | `.wavefoundry/framework/dashboard` | code | 214 |
| 1vry5 techdocs-pattern-fidelity | `docs/waves/1vry5 techdocs-pattern-fidelity` | code | 208 |
| upgrade_wavefoundry | `.wavefoundry/framework/scripts` | code | 197 |
| wave_lint_lib | `.wavefoundry/framework/scripts/wave_lint_lib` | code | 187 |
| subprocess_util | `.wavefoundry/framework/scripts` | code | 186 |
| chunker | `.wavefoundry/framework/scripts` | code | 179 |
| store | `.wavefoundry/framework/scripts` | code | 148 |
| context_efficiency | `.wavefoundry/framework/scripts` | code | 133 |
| indexer | `.wavefoundry/framework/scripts` | code | 124 |
| scripts/techdocs_audit_lib | `.wavefoundry/framework/scripts` | code | 115 |
| upgrade_bridge_bootstrap | `.wavefoundry/framework/scripts` | code | 92 |
| framework/scripts — validate_review_evidence_records | `.wavefoundry/framework/scripts` | code | 63 |
...
| graph_query | `.wavefoundry/framework/scripts` | code | 44 |
| framework/scripts — serialization_point_paths | `.wavefoundry/framework/scripts` | code | 41 |
| graph_cluster | `.wavefoundry/framework/scripts` | code | 40 |
| memory_eval | `.wavefoundry/framework/scripts` | code | 35 |
