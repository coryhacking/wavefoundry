...
| ---- | ---- | ---- | ------------ |
| tests | `.wavefoundry/framework/scripts/tests` | code | 6888 |
| server_impl | `.wavefoundry/framework/scripts` | code | 687 |
...
| setup | `.wavefoundry/framework/scripts` | code | 155 |
...
| dialog | `docs/design-system/components/dialog` | config | 31 |
