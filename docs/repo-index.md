...
| ---- | ---- | ---- | ------------ |
| tests | `.wavefoundry/framework/scripts/tests` | code | 7048 |
| server_impl | `.wavefoundry/framework/scripts` | code | 682 |
| graph | `.wavefoundry/framework/scripts` | code | 259 |
...
| upgrade_wavefoundry | `.wavefoundry/framework/scripts` | code | 127 |
| indexer | `.wavefoundry/framework/scripts` | code | 119 |
