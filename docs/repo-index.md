...
| ---- | ---- | ---- | ------------ |
| tests | `.wavefoundry/framework/scripts/tests` | code | 7490 |
...
| upgrade_wavefoundry | `.wavefoundry/framework/scripts` | code | 131 |
...
| store | `.wavefoundry/framework/scripts` | code | 58 |
