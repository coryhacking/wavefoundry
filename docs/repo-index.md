...
| ---- | ---- | ---- | ------------ |
| tests | `.wavefoundry/framework/scripts/tests` | code | 10479 |
| server_impl | `.wavefoundry/framework/scripts` | code | 942 |
| graph | `.wavefoundry/framework/scripts` | code | 355 |
| workflow-config | `.wavefoundry/framework/scripts` | code | 219 |
| dashboard | `.wavefoundry/framework/dashboard` | code | 214 |
| wave_lint_lib | `.wavefoundry/framework/scripts/wave_lint_lib` | code | 205 |
| upgrade_wavefoundry | `.wavefoundry/framework/scripts` | code | 191 |
...
| review_evidence | `.wavefoundry/framework/scripts` | code | 147 |
| context_efficiency | `.wavefoundry/framework/scripts` | code | 142 |
| dashboard/dashboard | `.wavefoundry/framework/scripts` | code | 141 |
...
| upgrade_bridge_bootstrap | `.wavefoundry/framework/scripts` | code | 47 |
| graph_di_signals | `.wavefoundry/framework/scripts` | code | 44 |
| lifecycle_id | `.wavefoundry/framework/scripts` | code | 41 |
