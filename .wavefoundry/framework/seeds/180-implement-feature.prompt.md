...
- **Hand off through existing artifacts.** For review or coordinator handoff, update the existing wave/change record with scope and ACs, reviewed revision or tree fingerprint, changed paths, commands/results, unresolved findings and next action. The receiver checks the current tree and evidence independently; a moved tree requires affected evidence to be refreshed. No shared chat transcript, extra Markdown packet, host/session registry or cross-host scheduler is required.
