...
11. Re-run the docs gate (**MCP:** **`wave_garden`** then **`wave_validate`** when attached; **CLI:** **`wf docs-gardener && wf docs-lint`**). Secret findings are **recorded, not blocking** — see "Secret findings during upgrade" below.
