...
- Before making a change, state the current behavior and why the change is needed; prefer the smallest correct change and do not refactor adjacent code unless the task requires it.
