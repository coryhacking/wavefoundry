...
class ReceiptTests(unittest.TestCase):
    ...
    def test_direct_identity_equalities_are_only_reviewed_boundaries(self):
        ...
        allowed = {('retrieval_eval', '_leftover_temporary_aliases', 'entry.st_dev == published.st_dev'),
         ...
         ('setup_readiness', 'assess_setup', "projected_environment(stamp.get('environment')) != projected_environment(_environment_identity())"),
         ('setup_readiness', 'write_setup_stamp', "identity.get('sources') != current['sources']"),
