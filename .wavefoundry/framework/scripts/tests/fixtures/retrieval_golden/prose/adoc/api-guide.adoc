...
This guide covers the everyday request patterns for the {product-name} API: client setup, authentication, pagination, and streaming.
The examples target API version {api-version}.
...
image::images/pagination-flow.png[Cursor pagination flow]
