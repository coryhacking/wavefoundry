...
This guide walks through installing the {product-name} client library and verifying that your environment is ready for development.
...
image::images/install-check.png[Successful verification output]
