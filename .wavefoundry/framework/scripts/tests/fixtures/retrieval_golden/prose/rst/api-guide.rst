...
The client connects lazily on the first request, or you can call :func:`connect` eagerly to validate credentials at startup.
...
.. image:: images/pagination-flow.png
   :alt: Cursor pagination flow
...
.. note::
   ...
   Forgetting to close the client can delay interpreter shutdown by up to the read timeout.
