...
Reconnect by calling :func:`connect` again after adjusting timeouts on a live client.
...
.. note::
   ...
   Debug logs may contain request payloads; scrub them before attaching logs to a public issue.
