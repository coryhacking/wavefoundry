...
through run_tests.py:
    ...
    # Run a single test class or method (RerankerTests lives in the
    # retrieval shard of the test_server_tools* family):
    python3 -m unittest tests.test_server_tools_retrieval.RerankerTests
    python3 -m unittest tests.test_server_tools_retrieval.RerankerTests.test_search_combined_returns_reranked_true_when_reranker_available
