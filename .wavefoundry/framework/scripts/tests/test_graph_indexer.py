...
class GeneratedCodeClassifierTests(unittest.TestCase):
    ...
    def test_tanstack_router_gen_ts_marks_generated(self):
        self.assertTrue(self._classify("apps/aceiss/src/routeTree.gen.ts",
...
class TsConfigPathAliasResolutionTests(unittest.TestCase):
    ...
    def test_wildcard_alias_resolves_to_real_file(self):
        self._write_tsconfig({"compilerOptions": {"baseUrl": ".", "paths": {"@aceiss/*": ["libs/*/src/index.ts"]}}})
        self._touch("libs/marketplace/src/index.ts", "export const f = 1;\n")
        src = self._touch("apps/web/src/main.ts")
        resolved = self.mod._resolve_ts_import_via_tsconfig("@aceiss/marketplace", str(src.relative_to(self.root)), self.root)
        self.assertEqual(resolved, "libs/marketplace/src/index.ts")

    def test_wildcard_alias_with_extension_probe(self):
        self._write_tsconfig({"compilerOptions": {"baseUrl": ".", "paths": {"@aceiss/*": ["libs/*"]}}})
        self._touch("libs/foo.ts", "export const x = 1;\n")
        src = self._touch("apps/web/src/main.ts")
        resolved = self.mod._resolve_ts_import_via_tsconfig("@aceiss/foo", str(src.relative_to(self.root)), self.root)
    ...
    def test_exact_alias_resolves(self):
        self._write_tsconfig({"compilerOptions": {"baseUrl": ".", "paths": {"@aceiss/marketplace": ["libs/marketplace/src/index.ts"]}}})
        self._touch("libs/marketplace/src/index.ts", "export const f = 1;\n")
        src = self._touch("apps/web/src/main.ts")
        resolved = self.mod._resolve_ts_import_via_tsconfig("@aceiss/marketplace", str(src.relative_to(self.root)), self.root)
        self.assertEqual(resolved, "libs/marketplace/src/index.ts")
    ...
    def test_no_match_returns_none(self):
        ...
        self.assertIsNone(self.mod._resolve_ts_import_via_tsconfig("@aceiss/missing", str(src.relative_to(self.root)), self.root))
