...
ALLOWLIST: dict[tuple[str, str], str] = {
    ...
    ("wf_server/server_impl.py", "already *inside* ``docs/waves/``)"): "docstring",
    ("wf_server/server_impl.py", "# relocate the file out of `docs/plans/`"): "comment",
    ("wf_server/memory_handlers.py", "recovery_usage=\"repair the local docs/waves path, then retry\""): "message",
    ("wf_server/server_impl.py", "# historical (docs/waves/) rows excluded by construction"): "comment",
    ("wf_server/upgrade_handlers.py", "# the full-corpus lint, which includes docs/waves"): "comment",
    ("wf_server/server_impl.py", "every ``docs/waves/`` record"): "docstring",
