...
- docs tooling wrappers like `./docs-lint` and `./docs-gardener`
...
| Docs tooling | `./docs-lint`, `./docs-gardener` | Enforces docs consistency and helps maintain the seeded surface over time. |
